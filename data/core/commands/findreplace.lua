...
local function get_find_tooltip()
  local rf = keymap.get_binding_for_drawing("find-replace:repeat-find")
  local ti = keymap.get_binding_for_drawing("find-replace:toggle-sensitivity")
  local tr = keymap.get_binding_for_drawing("find-replace:toggle-regex")
