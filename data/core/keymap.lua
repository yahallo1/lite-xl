...
keymap.add_direct {
  ...
  ["return"] = { "command:submit","context-menu:submit", "doc:newline", "dialog:select" },
  ...
  ["up"] = { "command:select-previous", "context-menu:focus-previous", "doc:move-to-previous-line" },
  ["down"] = { "command:select-next", "context-menu:focus-next", "doc:move-to-next-line" },
